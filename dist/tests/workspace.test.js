...
test('WorkspaceService summary returns suggestions', async (t) => {
    ...
    const workspace = new WorkspaceService(loggerStub, contextService, null, projectResolver, profileService, runbookService, capabilityService, projectService, aliasService, presetService, stateService);
