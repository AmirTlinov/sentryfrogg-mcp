...
test('PipelineManager ingests HTTP JSONL into Postgres', async () => {
    ...
    const pipelineManager = new PipelineManager(loggerStub, new Validation(loggerStub), apiManager, {}, postgresqlManager, null, null);
...
test('PipelineManager streams Postgres export into SFTP', async () => {
    ...
    const pipelineManager = new PipelineManager(loggerStub, new Validation(loggerStub), {}, sshManager, postgresqlManager, null, null);
    const result = await pipelineManager.handleAction({
        action: 'run',
